...
internal static partial class NativeMethods
{
    ...
    internal const uint GetModuleHandleExUnchangedRefCount =
        0x0000_0002;
    internal const uint GetModuleHandleExFromAddress =
        0x0000_0004;
    ...
    [LibraryImport(
        ...
        SetLastError = true)]
    internal static unsafe partial uint GetModuleFileName(
        nint module,
        char* fileName,
        uint size);
    ...
    [LibraryImport(
        ...
        SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    internal static unsafe partial bool Module32First(
        nint snapshot,
    ...
    [LibraryImport(
        ...
        SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    internal static unsafe partial bool Module32Next(
        nint snapshot,
        ModuleEntry* moduleEntry);
}
